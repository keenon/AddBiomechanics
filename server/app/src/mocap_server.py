        ...
        response = ses_client.send_email(
            ...
            Message={
                "Body": {
                    "Text": {
                        "Charset": CHARSET,
                        "Data":  "Your subject \"{0}\" has finished processing. Visit https://addbiomechanics.org/data/{1} to view and download. You can view in-browser visualizations of the uploaded trial data by clicking on each trial name.\n\nThank you for using BiomechNet!\n-BiomechNet team\n\nHaving problems or questions? Do not reply to this email. Please visit the AddBiomechanics forum on SimTK: https://simtk.org/plugins/phpBB/indexPhpbb.php?group_id=2402&pluginname=phpBB".format(name, path)
                    }
                },
                "Subject": {
                    "Charset": CHARSET,
